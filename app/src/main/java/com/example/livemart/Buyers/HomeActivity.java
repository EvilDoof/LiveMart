...
import com.example.livemart.Admin.AdminMaintainProductsActivity;
import com.example.livemart.Model.Products;
import com.example.livemart.Prevalent.Prevalent;
import com.example.livemart.R;
import com.example.livemart.SearchCategoriesActivity;
import com.example.livemart.SearchProductsActivity;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView userEmailTextView = headerView.findViewById(R.id.user_email_id);
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.txtProductStock.setText("Current stock = " + model.getStock());
